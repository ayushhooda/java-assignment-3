...
public class OperationsTest {
  ...
  private Operations obj = new Operations();
  ...
  public void getTimeOfZoneTest() {
    LocalDateTime localeDateAndTime = LocalDateTime.now();
    ZonedDateTime actualOutput = obj.getTimeOfZone("UTC");
    ZonedDateTime expectedOutput = ZonedDateTime.of(localeDateAndTime, ZoneId.of("UTC"));
